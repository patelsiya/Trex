var trex; var ground, invisibleg, cloud, cactus, gameState='play', cacti, cloudg, score=0, restart, gameover, jump, die, checkpoint;
function preload() {
...
function setup() {
 ...
 ground = createSprite(200,250,800,5); 
 ground.addAnimation("ground",ground1);
 ground.velocityX=-5;
  
  invisibleg = createSprite(200,255,800,5);
...
function draw() {
 ...
 gameover.visible=false;   
  ...
  ground.x=200;
    ...
    if(frameCount %90 == 0){
   var r= Math.round(random(90,150));
cloud = createSprite(400,r,20,20);
  ...
  if(frameCount %100 == 0){
  cactus = createSprite(400,235,10,10);
